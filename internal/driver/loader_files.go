...
// loader_files.go contains metadata parsing and import resolution helpers.
...
// resolveImport applies the resolver precedence used throughout dependency loading.
// Order is: builtin -> modules -> vendored -> GOPATH -> GOROOT -> module cache.
...
// resolveModuleCacheImport resolves external module packages from local module
// cache roots using the active module requirement maps.
